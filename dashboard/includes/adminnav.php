...
<img src="./../images/book_share.jpeg" alt="Logo" style="width:70px; margin-left:400px;">
                <a class="navbar-brand" href="index" style="color: white; text-align=center;">Online Notes Sharing</a>
            </div>
...
<div class="collapse navbar-collapse navbar-ex1-collapse bg-light" style="color:white;">
                <ul class="nav navbar-nav side-nav navbar-custom-2 ">
                    <li>
                        <a href="index.php" class="active"  style="color:white;" ><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                <?php if($_SESSION['role'] == 'admin') {
                   ...
                   <li>
                    ...
                    <li>
                         <a href="javascript:;" data-toggle="collapse" data-target="#user"  style="color:white;"><i class="fa fa-fw fa-users"></i> My Notes <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="user" class="collapse">
                            <li>
                                <a href="./notes.php"  style="color:white;">View All Notes</a>
                            </li>
                            <li>
                                <a href="./uploadnote.php"  style="color:white;">Upload Note</a>
                            </li>
